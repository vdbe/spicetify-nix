...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  comfySrc = {
    pname = "comfySrc";
    version = "9f9a975cd6f89feaa3baede13ea99bb630cdda95";
    src = fetchgit {
      url = "https://github.com/Comfy-Themes/Spicetify";
      rev = "9f9a975cd6f89feaa3baede13ea99bb630cdda95";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-BJlTj7sQkmoAc2TPT2gdA06pyqnNTcaXYsrX/VTBa2M=";
    };
    date = "2024-07-09";
  };
  ...
  officialSrc = {
    pname = "officialSrc";
    version = "757b5402b113df97543aa07dd6aaefed0b126756";
    src = fetchgit {
      url = "https://github.com/spicetify/spicetify-cli";
      rev = "757b5402b113df97543aa07dd6aaefed0b126756";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Fs8pQDA90BbsGfgZnFh2YlnoTE5hBP9PGHlZvtzaSEw=";
    };
    date = "2024-07-13";
  };
  officialThemes = {

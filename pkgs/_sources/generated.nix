...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  comfySrc = {
    pname = "comfySrc";
    version = "d877e70dd97ec11d50f6a64f9c7c0b8e511cfbe1";
    src = fetchgit {
      url = "https://github.com/Comfy-Themes/Spicetify";
      rev = "d877e70dd97ec11d50f6a64f9c7c0b8e511cfbe1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
  ...
  hidePodcastsSrc = {
    ...
    version = "0e6d7ddf94584024234ffa982de1791f655a0851";
    src = fetchgit {
      url = "https://github.com/theRealPadster/spicetify-hide-podcasts";
      rev = "0e6d7ddf94584024234ffa982de1791f655a0851";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-LbW4oCxPgeRcZey/c8iu7j1B7tF91KfiMJh9aTwLT+w=";
    };
    date = "2024-07-05";
  };
  historySrc = {
  ...
  officialSrc = {
    pname = "officialSrc";
    version = "0771018f9e757b37a144106c26fdcaea898c524e";
    src = fetchgit {
      url = "https://github.com/spicetify/spicetify-cli";
      rev = "0771018f9e757b37a144106c26fdcaea898c524e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-zX3DBKFIIFKwmWjwBKMI8g+znHPYbaT/PKo5MU7NV+A=";
    };
    date = "2024-07-04";
  };
  officialThemes = {

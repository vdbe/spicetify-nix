...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  comfySrc = {
    pname = "comfySrc";
    version = "88e46f53a6bebb14ed80d0e0c920826ba3f41ae9";
    src = fetchgit {
      url = "https://github.com/Comfy-Themes/Spicetify";
      rev = "88e46f53a6bebb14ed80d0e0c920826ba3f41ae9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-MDUm1ZANy5sy8Pg0qcP6NM8AOGOIIGrCht5vot4sn0s=";
    };
    date = "2024-06-02";
  };
  ...
  marketplaceSrc = {
    ...
    version = "8790fda05a05e655512637b5d16c20b06aacaeaa";
    src = fetchgit {
      url = "https://github.com/spicetify/spicetify-marketplace";
      rev = "8790fda05a05e655512637b5d16c20b06aacaeaa";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-2PgYc8EQoDkziCUNd+sYf5tg054UbQ2vyVoLSfyTKqw=";
    };
    date = "2024-06-01";
  };
  nameThatTuneSrc = {
